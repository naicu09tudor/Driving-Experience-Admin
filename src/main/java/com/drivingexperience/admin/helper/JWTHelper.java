package com.drivingexperience.admin.helper;
...
import static com.drivingexperience.admin.constant.JWTUtil.*;

@Component
public class JWTHelper {

    // JWT = token that contains header, payload and verified signature; header - contains the encryption algorithm
